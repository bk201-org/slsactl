...
var (
	...
	imageRepo = map[string]string{
		...
		"harvester/harvester":                                 "harvester/suse-virtualization",
		"harvester/harvester-webhook":                         "harvester/suse-virtualization",
		"harvester/harvester-upgrade":                         "harvester/suse-virtualization",
		"harvester/harvester-cluster-repo":                    "harvester/suse-virtualization",
		"bk201z/harvester-node-manager":                       "bk201-org/node-manager",
		"bk201z/harvester-node-manager-webhook":               "bk201-org/node-manager",
		"freezevicente/harvester-node-manager":                "bk201-org/node-manager",
		"freezevicente/harvester-node-manager-webhook":        "bk201-org/node-manager",
	}
	...
	identityOverride = map[string]string{
		...
		"harvester/harvester-mcp-server":                                  "^https://github.com/harvester/harvester-mcp-server/.github/workflows/release.yml@refs/(heads/main|tags/v.*)$",
		"harvester/load-balancer-harvester":                               "^https://github.com/harvester/load-balancer-harvester/.github/workflows/template-build.yml@refs/(heads/master|tags/prime-.*)$",
		"harvester/network-controller-harvester":                          "^https://github.com/harvester/network-controller-harvester/.github/workflows/template-build.yml@refs/(heads/master|tags/prime-.*)$",
		"harvester/networkfs-manager":                                     "^https://github.com/harvester/networkfs-manager/.github/workflows/factory.yml@refs/(heads/main|tags/prime-.*)$",
		"harvester/node-disk-manager":                                     "^https://github.com/harvester/node-disk-manager/.github/workflows/factory.yaml@refs/(heads/master|tags/prime-.*)$",
		"harvester/node-manager":                                          "^https://github.com/harvester/node-manager/.github/workflows/template-build.yml@refs/(heads/master|tags/prime-.*)$",
		"harvester/os2":                                                   "^https://github.com/harvester/os2/.github/workflows/factory.yml@refs/(heads/sle-micro|tags/prime-.*)$",
		"harvester/pcidevices":                                            "^https://github.com/harvester/pcidevices/.github/workflows/template-build.yml@refs/(heads/master|tags/prime-.*)$",
		"harvester/seeder":                                                "^https://github.com/harvester/seeder/.github/workflows/template-build.yml@refs/(heads/main|tags/prime-.*)$",
		"harvester/vm-import-controller":                                  "^https://github.com/harvester/vm-import-controller/.github/workflows/template-build.yml@refs/(heads/main|tags/prime-.*)$",
		"harvester/suse-virtualization":                                   "^https://github.com/harvester/suse-virtualization/.github/workflows/build-factory.yml@refs/(heads/v.*|tags/v.*)$",
		"bk201-org/node-manager":                                          "^https://github.com/bk201-org/node-manager/.github/workflows/template-build.yml@refs/(heads/master|tags/prime-.*)$",
	}
